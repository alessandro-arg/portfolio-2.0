...
function CopyEmailCard() {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center bg-cover bg-center">
      ...
      <span className="relative text-[rgb(0,0,0,65%)] dark:text-[rgb(255,255,255,90%)] font-instrument-serif w-full max-w-80 -translate-y-4 py-2 text-center text-4xl font-bold text-balance">
