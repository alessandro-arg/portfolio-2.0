...
export default function BackgroundFade() {
  return (
    <div className="absolute inset-0 z-[-1] h-[450px] w-full overflow-hidden bg-neutral-100/60 dark:bg-neutral-950/70 mask-[linear-gradient(rgb(0,0,0)_80%,rgba(0,0,0,0)_100%)] opacity-30">
      <Image
